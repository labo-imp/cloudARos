...
# instalar  R   version: 4.6 | released: 2026-05-21
...
sudo DEBIAN_FRONTEND=noninteractive  apt-get install --no-install-recommends software-properties-common dirmngr
...
sudo DEBIAN_FRONTEND=noninteractive nala install --assume-yes  --no-install-recommends r-base
sudo DEBIAN_FRONTEND=noninteractive nala install --assume-yes  --no-install-recommends r-base-dev
...
#------------------------------------------------------------------------------
# Instalo RStudio Server    Version: rstudio-server-2026.09.0-174  | Released: 2026-09 ----
...
rstudiopack="rstudio-server-2026.09.0-174-amd64.deb"
